...
export default function ProductCard(props) {
  ...
  return (
    ...
    <div className="card w-[180px] md:w-[230px] h-[360px] m-2 card-compact md:my-4 border-primary bg-base-100 shadow-xl">
      {
        props.image ? 
        <figure><img className=' h-[200px] min-h-52 max-h-52 object-contain rounded-xl' src={props.image} alt={props.name} /></figure>
        :<></>
      }
